...
<div class="row">
    <form action="{{ url('/profiles') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col p-4 rounded" style="background-color: #11262B;">
                ...
                <div class="col-2 px-0">
                    <div class="d-flex align-items-center">
                        <div class="form-group mb-3 mx-0 px-0">
                            ...
                            @else
                            <img src="{{ $user_data -> profile_photo }}" alt="" style="width: 4vw; height: 8vh;" class="rounded-circle mx-0 px-0">
                            @endif
                        </div>
            ...
            <div class="row px-2">
                <div class="col">
                    <button type="submit" class="btn" style="background-color: #C6DE41; color: black;">Save
                        Changes</button>
                </div>
            </div>
        </div>
