    ...
    <form action="{{ url('/postingan-details-update', $postingans -> id) }}" method="post" id="update-postingan-form">
        ...
        <div class="row p-3">
            ...
            <div class="col-6 p-3 px-4">
                ...
                <h5 id="endauc" class="text-light mb-4">Closing date : {{ $postingans -> endauc }}</h5>
                <div class="row">
                    <div class="col">
                ...
                <form action="{{ url('/bid-send', $postingans -> id) }}" method="post">
                    @csrf
        ...
        <div class="row p-3 mb-5">
            <div class="col">
                ...
                <h3 class="text-light">Description & Condition</h3>
