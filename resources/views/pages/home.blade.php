                ...
                <div class="row me-2">
                    <div class="col-md-6 rounded p-1">
                        <div class="rounded p-4" style="background-color: #0E2930;">
                            ...
                            <div class="col mb-4 pb-3" style="border-bottom: 1px solid #717171; cursor: pointer;"
                    ...
                    <div class="col-md-6 rounded p-1">
                        <div class="rounded p-4" style="background-color: #0E2930;">
                            <div class="row mb-3">
                                <div class="col">
                                    <h5 class="text-light fw-semibold">Team activity</h5>
                                </div>
                                <div class="col">
                                    <a href="#" class="text-light text-decoration-underline float-end">See all</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="row mt-5">
    <div class="row my-0">
        @if(count($data) < 1) <img class="d-block mx-auto" src="{{ asset('asset/No data found.svg') }}"
            ...
            @else
            <h3 class="text-light mb-4">Recently added</h3>
